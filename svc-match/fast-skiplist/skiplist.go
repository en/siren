...
func (list *SkipList) cmp(k1, k2 decimal.Decimal) bool {
	if list.inOrder {
		return k1.LessThanOrEqual(k2)
	}
	return k1.GreaterThanOrEqual(k2)
}
...
func (list *SkipList) Set(key decimal.Decimal, value interface{}) *Element {
	list.mutex.Lock()
...
func (list *SkipList) getPrevElementNodes(key decimal.Decimal) []*elementNode {
	var prev *elementNode = &list.elementNode
	var next *Element
...
func NewWithMaxLevel(maxLevel int, inOrder bool) *SkipList {
